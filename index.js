...
const displayStr = `A total of ${raisedCard.innerText} has been raised \
for ${gamesCard.innerText} games. Currently, ${totalUnfundedGames} \
${totalUnfundedGames == 1 ? 'game remains' : 'games remain'} unfunded. We need your help to fund these \
amazing games!`;
